...
namespace Euyuil.Azure.Storage.Helper.Tests
{
    ...
    public class UtilitiesTests
    {
        ...
        public void GetExpressionsOnePropertyTest()
        {
            ...
            Utilities.ParseLambdaExpression(e => e.Id, out memberTypes, out memberNames, out memberGetters, out memberSetters);
        ...
        public void GetExpressionsTwoPropertiesTest()
        {
            ...
            Func<TestModel, object>[] memberGetters;
            Action<TestModel, object>[] memberSetters;
            Utilities.ParseLambdaExpression(e => new { e.Id, e.Version }, out memberTypes, out memberNames, out memberGetters, out memberSetters);
        ...
        public void GetExpressionsTwoPropertiesOneConstantTest()
        {
            ...
            Func<TestModel, object>[] memberGetters;
            Action<TestModel, object>[] memberSetters;
            Utilities.ParseLambdaExpression(e => new { e.Id, e.Version, Dummy = "Constant" }, out memberTypes, out memberNames, out memberGetters, out memberSetters);
